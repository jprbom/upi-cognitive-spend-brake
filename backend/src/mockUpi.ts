...
const conceptCode = 'UPI_COGNITIVE_SPEND_BRAKE';
...
export function buildMockUpiResponse(input: MockUpiRailRequest) {
  ...
  return {
    ...
    concept: 'UPI Cognitive Spend Brake',
    txnId: input.txnId,
    ...
    npciStatus,
    responseCode,
    responseMessage: 'UPI Cognitive Spend Brake sandbox response for ' + input.purpose + '. No real UPI rail, NPCI, bank, PSP, or customer data is used.',
    settlement: {
