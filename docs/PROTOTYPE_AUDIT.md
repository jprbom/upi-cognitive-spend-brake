...
- The ML script is educational and synthetic, not statistically valid behavioural-finance or intervention model training.
- Persistence is JSON file storage, not a private local rule vault, encrypted personal finance store, or consent ledger.
- The UPI rail is fully mocked and does not connect to PSPs, banks, UPI Lite wallets, or real payment authorization flows.
