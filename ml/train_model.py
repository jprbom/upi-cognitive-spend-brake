"""Dependency-free AIML/DL training example for UPI Cognitive Spend Brake.
...
FEATURES = ["amount","category_risk","budget_used","late_night","repeated_count"]
TARGET = "impulse_friction"
ROWS = [[620,0.68,0.83,1,4,1],[52,0.12,0.41,0,1,0],[3499,0.74,0.92,0,3,1],[180,0.24,0.35,0,1,0],[1299,0.61,0.77,1,3,1]]
...
def main():
    ...
    report = {
        "project": "UPI Cognitive Spend Brake",
        "target": TARGET,
        "features": FEATURES,
